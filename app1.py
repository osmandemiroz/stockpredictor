...
if st.button('Analiz Et'):
    ...
    excel_data = pd.read_excel(output)
    ...
    # Excel dosyasını grafik olarak çizme
    fig, ax2 = plt.subplots(1, 1, figsize=(12, 6))
    ax2.plot(pd.to_datetime(excel_data['Tarih']), excel_data['Tahmin'], label='Tahminler', alpha=0.8)
    ax2.set_title('Gelecekteki Tahminler')
    ax2.legend()
    ax2.grid(True)
